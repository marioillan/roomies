...
const TITULOS = [
  ...
  [/^\/aviso-legal$/,               'Aviso legal', 'Aviso legal | Housie'],
  [/^\/privacidad$/,                'Política de privacidad', 'Política de privacidad | Housie'],
  [/^\/cookies$/,                   'Política de cookies', 'Política de cookies | Housie'],
