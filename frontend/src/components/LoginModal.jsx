        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              className={`w-full border rounded-xl px-4 py-3 text-slate-900 outline-none focus:ring-2 transition ${
                errors.email ? 'border-red-400 focus:ring-red-300' : 'border-slate-200 focus:ring-emerald-400'
              }`}
            />
            {errors.email && (
          ...
          <div>
            ...
            <input
              ...
              {...register('password')}
              className={`w-full border rounded-xl px-4 py-3 text-slate-900 outline-none focus:ring-2 transition ${
                errors.password ? 'border-red-400 focus:ring-red-300' : 'border-slate-200 focus:ring-emerald-400'
              }`}
            />
            {errors.password && (
          ...
          <p className="text-center text-sm text-slate-500">
            ...
            <a
              href="#"
              onClick={e => { e.preventDefault(); onSwitchToRegistro() }}
